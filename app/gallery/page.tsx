...
const matchaItems: MenuItemData[] = [
  ...
  { name: "Mango Matcha", description: "Mango and matcha fusion with a bright, smooth finish.", image: "", sizes: [{ label: "G", price: "$10.00" }] },
  { name: "Mango Sea Salt Matcha", description: "Mango matcha topped with sea salt foam.", image: "", sizes: [{ label: "G", price: "$11.00" }] },
];

const coldBrewItems: MenuItemData[] = [
  { name: "OG Cold Brew", description: "", image: "", sizes: [{ label: "G", price: "$9.00" }] },
  {
  ...
  { name: "Brown Sugar Cold Brew", description: "", image: "", sizes: [{ label: "G", price: "$9.00" }] },
  { name: "Black Pearl Cold Brew Latte", description: "", image: "", sizes: [{ label: "G", price: "$9.00" }] },
  {
...
const coffeeItems: MenuItemData[] = [
  ...
  },
  {
    ...
    sizes: [{ label: "G", price: "$6.50" }],
    sizesByTemperature: {
      Hot: [{ label: "G", price: "$6.50" }],
      Iced: [{ label: "G", price: "$6.50" }],
    },
  ...
  },
  {
    ...
    description: "",
    image: "",
    sizes: [{ label: "G", price: "$8.50" }],
    sizesByTemperature: {
      Hot: [{ label: "G", price: "$8.50" }],
      Iced: [{ label: "G", price: "$8.50" }],
    },
    temperatureOptionsOverride: ["Hot", "Iced"],
    coffeeShots: true,
  },
...
const cloudItems: MenuItemData[] = [
  { name: "Black Pearl Coconut Cloud", description: "Refreshing coconut water and homemade black gulaman cloud foam.", image: "", sizes: [{ label: "G", price: "$9.00" }] },
  { name: "Clover Coconut Cloud", description: "Refreshing coconut water and premium Kyoto Thea matcha powder cloud foam.", image: "", sizes: [{ label: "G", price: "$9.00" }] },
  { name: "Twilight Coconut Cloud", description: "Refreshing coconut water and homemade ube cloud foam.", image: "", sizes: [{ label: "G", price: "$9.00" }] },
  {
    name: "Batirol Cloud",
