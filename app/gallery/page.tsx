...
const matchaItems: MenuItemData[] = [
  { name: "Earl Grey Matcha", description: "Premium Kyoto matcha with earl grey notes. Choose your matcha strength below.", image: "", sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }], temperatureOptionsOverride: ["Hot", "Iced"] },
  {
    name: "OG Matcha Latte",
    description: "Fully customisable — syrups, cold foams, milk, temperature, matcha strength, and sweetness.",
    image: "",
    sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }],
  ...
  { name: "Ube Cream Matcha", description: "Ube cream and matcha. Default is 4g matcha, but you can select extra strong options.", image: "", sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }], temperatureOptionsOverride: ["Hot", "Iced"] },
...
const coldBrewItems: MenuItemData[] = [
  { name: "OG Cold Brew", description: "", image: "", sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }] },
  {
  ...
  { name: "Brown Sugar Cold Brew", description: "", image: "", sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }] },
  { name: "Black Pearl Cold Brew Latte", description: "", image: "", sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }] },
  {
...
const coffeeItems: MenuItemData[] = [
  ...
  },
  {
    ...
    description: "",
    image: "",
    sizes: [{ label: "G", price: "$9.50" }, { label: "V", price: "$10.50" }],
  ...
  },
  {
    ...
    sizesByTemperature: {
      Hot: [{ label: "G", price: "$8.50" }, { label: "V", price: "$9.50" }],
      Iced: [{ label: "G", price: "$8.50" }, { label: "V", price: "$9.50" }],
    },
    temperatureOptionsOverride: ["Hot", "Iced"],
    coffeeShots: true,
  },
...
const cloudItems: MenuItemData[] = [
  { name: "Black Pearl Coconut Cloud", description: "Refreshing coconut water and homemade black gulaman cloud foam.", image: "", sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }] },
  { name: "Clover Coconut Cloud", description: "Refreshing coconut water and premium Kyoto Thea matcha powder cloud foam.", image: "", sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }] },
  { name: "Twilight Coconut Cloud", description: "Refreshing coconut water and homemade ube cloud foam.", image: "", sizes: [{ label: "G", price: "$9.00" }, { label: "V", price: "$11.00" }] },
  {
    name: "Batirol Cloud",
