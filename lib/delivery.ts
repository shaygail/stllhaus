...
export const DELIVERY_FEE_EXTENDED_FROM_CBD = 6;
...
export function deliveryTierCustomerLabel(tier: DeliveryTier): string {
  ...
  return "Further from the CBD, e.g. Westown or Taranaki Base ($6)";
}

/** Shown on checkout. */
export const DELIVERY_SERVICE_AREA_NOTE =
  "Free delivery around Bell Block. $4 for Waitara and through to the New Plymouth CBD. $6 for addresses further from the CBD (such as Westown or Taranaki Base Hospital). Outside our delivery area, please choose pickup.";
