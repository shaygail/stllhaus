...
export const BACKEND_NAME_ALIASES: Record<string, string[]> = {
  ...
  "OG Hojicha Latte": ["Hojicha Latte"],
...
export const MENU_DRINKS = {
  ...
  hojicha: {
    ...
    strawberryLatte: { regular: 8.5, large: 10.5 },
    strawberryCloud: { regular: 8.5, large: 10.5 },
    ubeCream: { regular: 8.5, large: 10.5 },
    mango: { regular: 8.5, large: 10.5 },
    mangoSeaSalt: { regular: 8.5, large: 10.5 },
  },
  coldBrew: {
    og: { regular: 8.5, large: 10.5 },
    ubeCream: { regular: 8.5, large: 10.5 },
...
export const MENU_DRINK_ROWS: { name: string; prices: DrinkPrices }[] = [
  ...
  { name: "Earl Grey Hojicha", prices: MENU_DRINKS.hojicha.earlGrey },
  { name: "OG Hojicha Latte", prices: MENU_DRINKS.hojicha.og },
  { name: "Strawberry Hojicha", prices: MENU_DRINKS.hojicha.strawberry },
  { name: "Strawberry Hojicha Latte", prices: MENU_DRINKS.hojicha.strawberryLatte },
  { name: "Strawberry Cloud Hojicha", prices: MENU_DRINKS.hojicha.strawberryCloud },
  { name: "Ube Cream Hojicha", prices: MENU_DRINKS.hojicha.ubeCream },
  { name: "Mango Hojicha", prices: MENU_DRINKS.hojicha.mango },
  { name: "Mango Sea Salt Hojicha", prices: MENU_DRINKS.hojicha.mangoSeaSalt },
